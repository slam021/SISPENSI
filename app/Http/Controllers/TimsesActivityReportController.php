...
class TimsesActivityReportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('content/TimsesActivityReport_view/ReportTimsesActivity', compact('programtimsesactivity', 'start_date', 'end_date', 'listcoretimses', 'timses_id'));
    }
    ...
    public function filterResetTimsesActivityReport()
    {
    ...
    public function exportTimsesActivityReport()
    {
        if(!Session::get('start_date')){
            $start_date     = date('Y-m-d');
        }else{
