...
class FundingIncomeReport2Controller extends Controller
{
    ...
    public function index()
    {
        ...
        $fundingincome = FinancialFlow::where('financial_flow.data_state', '=', 0)
        ...
        return view('content/FundingIncomeReport2_view/ReportFundingIncome', compact('fundingincome', 'start_date', 'end_date', 'coretimses'));
    }

    public function filterFundingIncomeReport2(Request $request)
    {
        ...
        return redirect('/report-income2');
    }

    public function filterResetFundingIncomeReport2()
    {
    ...
    public function printFundingIncomeReport2()
    {
        if(!Session::get('start_date')){
            $start_date     = date('Y-m-d');
        }else{
    ...
    public function exportFundingIncomeReport2()
    {
        if(!Session::get('start_date')){
            $start_date     = date('Y-m-d');
        }else{
