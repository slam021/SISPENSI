...
class FundingExpenditureReport2Controller extends Controller
{
    ...
    public function index()
    {
        ...
        $fundingexpenditure = FinancialFlow::where('financial_flow.data_state', '=', 0)
        ...
        return view('content/FundingExpenditureReport2_view/ReportFundingExpenditure', compact('fundingexpenditure', 'start_date', 'end_date',  'coretimses'));
    }

    public function filterFundingExpenditureReport2(Request $request)
    {
        ...
        return redirect('/report-expenditure2');
    }

    public function filterResetFundingExpenditureReport2()
    {
    ...
    public function printFundingExpenditureReport2()
    {
        if(!Session::get('start_date')){
            $start_date     = date('Y-m-d');
        }else{
    ...
    public function exportFundingExpenditureReport2()
    {
        if(!Session::get('start_date')){
            $start_date     = date('Y-m-d');
        }else{
