...
<div class="card border border-dark">
    ...
    <?php 
            if (empty($corelocation)){
                $corelocation['location_name'] = '';
            }
        ?>

    <form method="post" action="{{route('process-add-location')}}" enctype="multipart/form-data">
    @csrf
        <div class="card-body">
            <div class="row form-group">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control input-bb" type="text" name="location_name" id="location_name" value="{{old('location_name')}}"  autocomplete="off" required/>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">	
                        ...
                        {!! Form::select('province_id', $province, 0, ['class' => 'selection-search-clear select-form', 'id' => 'province_id','required' ])!!}
                        {{-- <input class="form-control input-bb" type="hidden" name="province_id" id="province_id" value="{{$corelocation['province_id']}}"  autocomplete="off"/> --}}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <a class="text-dark">Kabupaten/Kota<a class='red'> *</a></a>
                        <select class="selection-search-clear" name="city_id" id="city_id" style="width: 100% !important" required>
                        </select>
                        {{-- <input class="form-control input-bb" type="hidden" name="city_id" id="city_id" value="{{$corelocation['city_id']}}"  autocomplete="off"/> --}}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <a class="text-dark">Kecamatan<a class='red'> *</a></a>
                        <select class="selection-search-clear" name="kecamatan_id" id="kecamatan_id" style="width: 100% !important" required>
                        </select>
                        {{-- <input class="form-control input-bb" type="hidden" name="kecamatan_id" id="kecamatan_id" value="{{$corelocation['kecamatan_id']}}"  autocomplete="off"/> --}}
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="selection-search-clear" name="kelurahan_id" id="kelurahan_id" style="width: 100% !important" required>
                        </select>
                        {{-- <input class="form-control input-bb" type="hidden" name="kelurahan_id" id="kelurahan_id" value="{{$corelocation['kelurahan_id']}}"  autocomplete="off"/> --}}
