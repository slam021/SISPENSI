...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Edit Kategori Keuangan</li>
    </ol>
</nav>
...
@endif
    ...
    <form method="post" action="{{url('/financial-category/process-edit')}}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="row form-group">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control input-bb" type="text" name="financial_category_name" id="financial_category_name" value="{{$financialcategory->financial_category_name}}" autocomplete="off" />
                        <input class="form-control input-bb" type="hidden" name="financial_category_id" id="financial_category_id" value="{{$financialcategory->financial_category_id}}" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <a class="text-dark">Tipe Kategori<a class='red'> *</a></a>
                        {!! Form::select('financial_category_type', $type, $financialcategory->financial_category_type, ['class' => 'selection-search-clear select-form', 'id' => 'financial_category_type','' ])!!}
                    </div>
                </div>
            </div>
        </div>
