...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('funding-income') }}">Daftar Pemasukan Keuangan</a></li>
...
@endif
    ...
    <form method="post" action="{{route('process-edit-funding-expenditure-candidate')}}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="row form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <a class="text-dark">Kandidat<a class='red'> *</a></a>
                        {!! Form::select('candidate_id', $corecandidate, $fundingexpenditure->candidate_id, ['class' => 'selection-search-clear select-form', 'id' => 'candidate_id','' ])!!}
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
