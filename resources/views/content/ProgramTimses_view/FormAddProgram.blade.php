...
<div class="card border border-dark">
    <div class="card-header border-dark bg-dark">
        ...
        <form method="post" action="{{route('process-add-program2')}}" enctype="multipart/form-data">
            @csrf
                <div class="card-body">
                    <div class="row form-group">
                        {{-- <div class="col-md-3">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control input-bb" type="hidden" name="timses_id" id="timses_id" value="{{$coretimses}}"  autocomplete="off"/>
                                <input class="form-control input-bb" type="hidden" name="program_organizer" id="program_organizer" value="{{2}}"  autocomplete="off"/>
