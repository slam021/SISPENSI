...
{{-- <div class="card border border-dark">
    <div class="card-header border-dark bg-dark">
        ...
        <div class="float-right">
            <button onclick="location.href='{{ url('program-timses') }}'" name="Find" class="btn btn-sm btn-info" title="Back"><i class="fa fa-angle-left"></i>  Kembali</button>
        </div>
    </div>
...
{{-- <div class="card-body">
    ...
    <div class="card border border-dark">
        ...
        <form method="post" action="{{route('process-edit-program2')}}" enctype="multipart/form-data">
            @csrf
        <div class="card-body">
                <div class="row form-group">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" type="hidden" name="program_id" id="program_id" value="{{$program->program_id}}" autocomplete="off"/>
                            <input class="form-control input-bb" type="hidden" name="program_organizer" id="program_organizer" value="{{$program->program_organizer}}" autocomplete="off"/>
                            <input class="form-control input-bb" type="hidden" name="timses_id" id="timses_id" value="{{$program->timses_id}}" autocomplete="off"/>
                        </div>
                    </div>
                    {{-- <div class="col-md-3">
                        <div class="form-group">
