@inject('ReportFX', 'App\Http\Controllers\FundingExpenditureReport2Controller')
...
@endif 
    <form  method="post" action="{{ route('filter-report-expenditure2') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                ...
                <div class="card-footer text-muted">
                    <div class="form-actions float-right">
                        <a href="{{ route('filter-reset-report-expenditure2') }}" type="button" name="Reset" class="btn bg-yellow btn-sm"><i class="fas fa-sync"></i> Reset</a>
...
<div class="card border border-dark">
    ...
    <div class="card-body table-responsive">
        ...
        <div class="card-footer text-muted">
            <div class="form-actions float-right">
                <a class="btn bg-orange btn-sm" href="{{ url('/report-expenditure2/print') }}"><i class="fa fa-file-pdf"></i> Pdf</a>
                <a class="btn bg-olive btn-sm" href="{{ url('/report-expenditure2/export') }}"><i class="fa fa-download"></i> Export Data</a>
            </div>
        </div>
    </div>
    <br>
