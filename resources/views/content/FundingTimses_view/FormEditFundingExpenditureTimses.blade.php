...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('income') }}">Daftar Pemasukan Keuangan Timses</a></li>
...
@endif
    ...
    <div class="card-header border-dark bg-dark">
        ...
        <div class="float-right">
            <button onclick="location.href='{{ url('expenditure-timses') }}'" name="Find" class="btn btn-sm btn-info" title="Back"><i class="fa fa-angle-left"></i>  Kembali</button>
        </div>
    </div>

    <form method="post" action="{{route('process-edit-expenditure-timses')}}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="row form-group">
                ...
                {{-- <div class="col-md-3">
                    <div class="form-group">
                        ...
                        {!! Form::select('timses_id', $coretimses, $fundingexpenditure->timses_id, ['class' => 'selection-search-clear select-form', 'id' => 'timses_id','' ])!!}
                    </div>
                </div> --}}
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control input-bb" type="text" name="financial_flow_nominal_view" id="financial_flow_nominal_view" value="{{$fundingexpenditure->financial_flow_nominal}}" autocomplete="off" onchange="rupiahSave();" />
                        <input class="form-control input-bb" type="hidden" name="financial_flow_nominal" id="financial_flow_nominal" value="{{$fundingexpenditure->financial_flow_nominal}}" autocomplete="off" />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
