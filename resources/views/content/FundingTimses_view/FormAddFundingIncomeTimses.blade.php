@inject('FIT', 'App\Http\Controllers\FundingTimsesController')
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('income-timses') }}">Daftar Pemasukan Keuangan Timses</a></li>
...
@endif
    ...
    <form method="post" action="{{route('process-add-income-timses')}}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="row form-group">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        {{-- <input class="form-control input-bb" type="hidden" name="timses_id" id="timses_id" value="{{$user_login}}" autocomplete="off" disabled /> --}}
                    </div>
                </div>
                {{-- <div class="col-md-3">
                    <div class="form-group">
