@inject('FundingIncome', 'App\Http\Controllers\FundingIncomeController')
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Daftar Pemasukan Keuangan Kandidat</li>
    </ol>
</nav>
@stop
...
@section('content')
<h3 class="page-title">
    <b>Daftar Pemasukan Keuangan Kandidat</b>
</h3>
@if(session('msg'))
...
<div class="card border border-dark">
    <div class="card-header bg-dark clearfix">
        ...
        <div class="form-actions float-right">
            <button onclick="location.href='{{ url('funding-income-candidate/add') }}'" name="add" class="btn btn-sm bg-cyan" title="Add Data"><i class="fa fa-plus"></i> Tambah Pemasukan Keuangan Baru</button>
        </div>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="" style='text-align:center'>
                            <a type="button" class="badge badge-warning btn-sm" href="{{ url('/funding-income-candidate/edit/'.$val['financial_flow_id'])}}"><i class='fas fa-edit'></i> Edit</a>
                            <a type="button" class="badge badge-danger btn-sm" href="{{ url('/funding-income-candidate/delete-funding-income/'.$val['financial_flow_id']) }}"><i class='far fa-trash-alt'></i> Hapus</a>
                        </td>
                    </tr>
                    <?php $no++; ?>
                    @endforeach
