...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('funding-income') }}">Daftar Pemasukan Keuangan  Kandidat</a></li>
        <li class="breadcrumb-item active" aria-current="page">Edit Pemasukan Keuangan Kandidat</li>
    </ol>
</nav>
...
@endif
    ...
    <div class="card-header border-dark bg-dark">
        <h5 class="mb-0 float-left">
            Form Edit Pemasukan Keuangan kandidat
        </h5>
        <div class="float-right">
            <button onclick="location.href='{{ url('funding-income-candidate') }}'" name="Find" class="btn btn-sm btn-info" title="Back"><i class="fa fa-angle-left"></i>  Kembali</button>
        </div>
    </div>

    <form method="post" action="{{url('/funding-income-candidate/process-edit')}}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="row form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('candidate_id', $corecandidate, $fundingincome->candidate_id, ['class' => 'selection-search-clear select-form', 'id' => 'candidate_id','' ])!!}
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
