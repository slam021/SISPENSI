...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Tambah Pemasukan Keuangan Kandidat</li>
    </ol>
</nav>
...
@endif
    ...
    <form method="post" action="{{route('process-add-funding-income-candidate')}}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="row form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control input-bb" type="text" name="financial_flow_nominal" id="financial_flow_nominal" value="{{old('financial_flow_nominal')}}" autocomplete="off" />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
